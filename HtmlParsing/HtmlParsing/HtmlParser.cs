    ...
    public static class HtmlParser
    {
        ...
        private static int FindClosingTagIndex(string tagName, string html, int startIndex)
        {
            ...
            while (ix > -1 && ix < html.Length)
            {
                ...
                var ix1 = html.IndexOf(tag1, ix, StringComparison.InvariantCultureIgnoreCase);
                var ix2 = html.IndexOf(tag2, ix, StringComparison.InvariantCultureIgnoreCase);
                ...
                var ix3 = html.IndexOf("<script ", ix, StringComparison.InvariantCultureIgnoreCase);
                if (ix3 > -1 && ix3 < ix2)
                {
